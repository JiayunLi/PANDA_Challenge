...
if __name__ == "__main__":
    ...
    OUT_TRAIN = '../input/panda-64x256x256-tiles-data-spine/train.zip'  ## output image folder
    OUT_MASKS = '../input/panda-64x256x256-tiles-data-spine/masks.zip'  ## ouput label folder
