...
if __name__ == "__main__":
    ...
    OUT_TRAIN = '../input/panda-64x256x256-tiles-data-spine/train3.zip'  ## output image folder
    OUT_MASKS = '../input/panda-64x256x256-tiles-data-spine/masks3.zip'  ## ouput label folder
    ...
    img_ids = [name[:-10] for name in os.listdir(MASKS)][7500:10000]
